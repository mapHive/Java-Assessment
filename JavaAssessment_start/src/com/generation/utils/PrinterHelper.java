...
//        System.out.println( "| Enter student birth date(MM/dd/yyyy)|" );
        ...
        // Initialize a Date object to store the parsed birthDate

        Date birthDate = null;

        // Keep prompting the user for input until a valid date format is entered

        while (birthDate == null) {
            System.out.print("Enter your birth date (MM/dd/yyyy): ");
            String userInput = scanner.next();
            try {
                // Attempt to parse the user input as a date as defined in formatter in the above code
                birthDate = formatter.parse(userInput);
            } catch (ParseException e) {
                // If the input is not in the correct format, inform the user and continue the loop
